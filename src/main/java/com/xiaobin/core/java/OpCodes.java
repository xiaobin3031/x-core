...
/**
 * created by xuweibin at 2025-01-11T18:45:35.545576500
 */
abstract class OpCodes {

  final int opCode;
  final String name;
  OpCodes(int opCode, String name){
    this.opCode = opCode;
    this.name = name;
  }
  ...
  static class Aaload extends OpCodes {

    Aaload(){ super(50, "aaload"); }
  ...
  static class Aastore extends OpCodes {

    Aastore(){ super(83, "aastore"); }
  ...
  static class Aconst_null extends OpCodes {

    Aconst_null(){ super(1, "aconst_null"); }
  ...
  static class Aload extends OpCodes {

    Aload(){ super(25, "aload"); }
 byte index;
  ...
  static class Aload_0 extends OpCodes {

    Aload_0(){ super(42, "aload_0"); }
  ...
  static class Aload_1 extends OpCodes {

    Aload_1(){ super(43, "aload_1"); }
  ...
  static class Aload_2 extends OpCodes {

    Aload_2(){ super(44, "aload_2"); }
  ...
  static class Aload_3 extends OpCodes {

    Aload_3(){ super(45, "aload_3"); }
  ...
  static class Anewarray extends OpCodes {

    Anewarray(){ super(189, "anewarray"); }
 byte indexbyte1;
 byte indexbyte2;
  ...
  static class Areturn extends OpCodes {

    Areturn(){ super(176, "areturn"); }
  ...
  static class Arraylength extends OpCodes {

    Arraylength(){ super(190, "arraylength"); }
  ...
  static class Astore extends OpCodes {

    Astore(){ super(58, "astore"); }
 byte index;
  ...
  static class Astore_0 extends OpCodes {

    Astore_0(){ super(75, "astore_0"); }
  ...
  static class Astore_1 extends OpCodes {

    Astore_1(){ super(76, "astore_1"); }
  ...
  static class Astore_2 extends OpCodes {

    Astore_2(){ super(77, "astore_2"); }
  ...
  static class Astore_3 extends OpCodes {

    Astore_3(){ super(78, "astore_3"); }
  ...
  static class Athrow extends OpCodes {

    Athrow(){ super(191, "athrow"); }
  ...
  static class Baload extends OpCodes {

    Baload(){ super(51, "baload"); }
  ...
  static class Bastore extends OpCodes {

    Bastore(){ super(84, "bastore"); }
  ...
  static class Bipush extends OpCodes {

    Bipush(){ super(16, "bipush"); }
 byte bb;
  ...
  static class Caload extends OpCodes {

    Caload(){ super(52, "caload"); }
  ...
  static class Castore extends OpCodes {

    Castore(){ super(85, "castore"); }
  ...
  static class Checkcast extends OpCodes {

    Checkcast(){ super(192, "checkcast"); }
 byte indexbyte1;
 byte indexbyte2;
  ...
  static class D2f extends OpCodes {
  ...
  static class D2i extends OpCodes {
  ...
  static class D2l extends OpCodes {
  ...
  static class Dadd extends OpCodes {
  ...
  static class Dalod extends OpCodes {

    Dalod(){ super(49, "dalod"); }
  ...
  static class Dastore extends OpCodes {

    Dastore(){ super(82, "dastore"); }
  ...
  static class Dcmpg extends OpCodes {

    Dcmpg(){ super(152, "dcmpg"); }
  ...
  static class Dcmpl extends OpCodes {

    Dcmpl(){ super(151, "dcmpl"); }
  ...
  static class Dconst_0 extends OpCodes {

    Dconst_0(){ super(14, "dconst_0"); }
  ...
  static class Dconst_1 extends OpCodes {

    Dconst_1(){ super(15, "dconst_1"); }
  ...
  static class Ddiv extends OpCodes {
  ...
  static class Dload extends OpCodes {

    Dload(){ super(24, "dload"); }
 byte index;
  ...
  static class Dload_0 extends OpCodes {

    Dload_0(){ super(38, "dload_0"); }
  ...
  static class Dload_1 extends OpCodes {

    Dload_1(){ super(39, "dload_1"); }
  ...
  static class Dload_2 extends OpCodes {

    Dload_2(){ super(40, "dload_2"); }
  ...
  static class Dload_3 extends OpCodes {

    Dload_3(){ super(41, "dload_3"); }
  ...
  static class Dmul extends OpCodes {
  ...
  static class Dneg extends OpCodes {
  ...
  static class Drem extends OpCodes {
  ...
  static class Dreturn extends OpCodes {

    Dreturn(){ super(175, "dreturn"); }
  ...
  static class Dstore extends OpCodes {

    Dstore(){ super(57, "dstore"); }
 byte index;
  ...
  static class Dstore_0 extends OpCodes {

    Dstore_0(){ super(71, "dstore_0"); }
  ...
  static class Dstore_1 extends OpCodes {

    Dstore_1(){ super(72, "dstore_1"); }
  ...
  static class Dstore_2 extends OpCodes {

    Dstore_2(){ super(73, "dstore_2"); }
  ...
  static class Dstore_3 extends OpCodes {

    Dstore_3(){ super(74, "dstore_3"); }
  ...
  static class Dsub extends OpCodes {
  ...
  static class Dup extends OpCodes {
  ...
  static class Dup_x1 extends OpCodes {

    Dup_x1(){ super(90, "dup_x1"); }
  ...
  static class Dup_x2 extends OpCodes {

    Dup_x2(){ super(91, "dup_x2"); }
  ...
  static class Dup2 extends OpCodes {
  ...
  static class Dup2_x1 extends OpCodes {

    Dup2_x1(){ super(93, "dup2_x1"); }
  ...
  static class Dup2_x2 extends OpCodes {

    Dup2_x2(){ super(94, "dup2_x2"); }
  ...
  static class F2d extends OpCodes {
  ...
  static class F2i extends OpCodes {
  ...
  static class F2l extends OpCodes {
  ...
  static class Fadd extends OpCodes {
  ...
  static class Faload extends OpCodes {

    Faload(){ super(48, "faload"); }
  ...
  static class Fastore extends OpCodes {

    Fastore(){ super(81, "fastore"); }
  ...
  static class Fcmpg extends OpCodes {

    Fcmpg(){ super(150, "fcmpg"); }
  ...
  static class Fcmpl extends OpCodes {

    Fcmpl(){ super(149, "fcmpl"); }
  ...
  static class Fconst_0 extends OpCodes {

    Fconst_0(){ super(11, "fconst_0"); }
  ...
  static class Fconst_1 extends OpCodes {

    Fconst_1(){ super(12, "fconst_1"); }
  ...
  static class Fconst_2 extends OpCodes {

    Fconst_2(){ super(13, "fconst_2"); }
  ...
  static class Fdiv extends OpCodes {
  ...
  static class Fload extends OpCodes {

    Fload(){ super(23, "fload"); }
 byte index;
  ...
  static class Fload_0 extends OpCodes {

    Fload_0(){ super(34, "fload_0"); }
  ...
  static class Fload_1 extends OpCodes {

    Fload_1(){ super(35, "fload_1"); }
  ...
  static class Fload_2 extends OpCodes {

    Fload_2(){ super(36, "fload_2"); }
  ...
  static class Fload_3 extends OpCodes {

    Fload_3(){ super(37, "fload_3"); }
  ...
  static class Fmul extends OpCodes {
  ...
  static class Fneg extends OpCodes {
  ...
  static class Frem extends OpCodes {
  ...
  static class Freturn extends OpCodes {

    Freturn(){ super(174, "freturn"); }
  ...
  static class Fstore extends OpCodes {

    Fstore(){ super(56, "fstore"); }
 byte index;
  ...
  static class Fstore_0 extends OpCodes {

    Fstore_0(){ super(67, "fstore_0"); }
  ...
  static class Fstore_1 extends OpCodes {

    Fstore_1(){ super(68, "fstore_1"); }
  ...
  static class Fstore_2 extends OpCodes {

    Fstore_2(){ super(69, "fstore_2"); }
  ...
  static class Fstore_3 extends OpCodes {

    Fstore_3(){ super(70, "fstore_3"); }
  ...
  static class Fsub extends OpCodes {
  ...
  static class Getfield extends OpCodes {

    Getfield(){ super(180, "getfield"); }
 byte indexbyte1;
 byte indexbyte2;
  ...
  static class Getstatic extends OpCodes {

    Getstatic(){ super(178, "getstatic"); }
 byte indexbyte1;
 byte indexbyte2;
  ...
  static class Goto extends OpCodes {
 ...
 byte indexbyte2;
  ...
  static class Goto_w extends OpCodes {

    Goto_w(){ super(200, "goto_w"); }
 byte branchbyte1;
 byte branchbyte2;
 byte branchbyte3;
 byte branchbyte4;
  ...
  static class I2b extends OpCodes {
  ...
  static class I2c extends OpCodes {
  ...
  static class I2d extends OpCodes {
  ...
  static class I2f extends OpCodes {
  ...
  static class I2l extends OpCodes {
  ...
  static class I2s extends OpCodes {
  ...
  static class Iadd extends OpCodes {
  ...
  static class Iaload extends OpCodes {

    Iaload(){ super(46, "iaload"); }
  ...
  static class Iand extends OpCodes {
  ...
  static class Iastore extends OpCodes {

    Iastore(){ super(79, "iastore"); }
  ...
  static class Iconst_m1 extends OpCodes {

    Iconst_m1(){ super(2, "iconst_m1"); }
  ...
  static class Iconst_0 extends OpCodes {

    Iconst_0(){ super(3, "iconst_0"); }
  ...
  static class Iconst_1 extends OpCodes {

    Iconst_1(){ super(4, "iconst_1"); }
  ...
  static class Iconst_2 extends OpCodes {

    Iconst_2(){ super(5, "iconst_2"); }
  ...
  static class Iconst_3 extends OpCodes {

    Iconst_3(){ super(6, "iconst_3"); }
  ...
  static class Iconst_4 extends OpCodes {

    Iconst_4(){ super(7, "iconst_4"); }
  ...
  static class Iconst_5 extends OpCodes {

    Iconst_5(){ super(8, "iconst_5"); }
  ...
  static class Idiv extends OpCodes {
  ...
  static class If_acmpeq extends OpCodes {

    If_acmpeq(){ super(165, "if_acmpeq"); }
 byte branchbyte1;
 byte branchbyte2;
  ...
  static class If_acmpne extends OpCodes {

    If_acmpne(){ super(166, "if_acmpne"); }
 byte branchbyte1;
 byte branchbyte2;
  ...
  static class If_icmpeq extends OpCodes {

    If_icmpeq(){ super(159, "if_icmpeq"); }
 byte branchbyte1;
 byte branchbyte2;
  ...
  static class If_icmpne extends OpCodes {

    If_icmpne(){ super(160, "if_icmpne"); }
 byte branchbyte1;
 byte branchbyte2;
  ...
  static class If_icmplt extends OpCodes {

    If_icmplt(){ super(161, "if_icmplt"); }
 byte branchbyte1;
 byte branchbyte2;
  ...
  static class If_icmpge extends OpCodes {

    If_icmpge(){ super(162, "if_icmpge"); }
 byte branchbyte1;
 byte branchbyte2;
  ...
  static class If_icmpgt extends OpCodes {

    If_icmpgt(){ super(163, "if_icmpgt"); }
 byte branchbyte1;
 byte branchbyte2;
  ...
  static class If_icmple extends OpCodes {

    If_icmple(){ super(164, "if_icmple"); }
 byte branchbyte1;
 byte branchbyte2;
  ...
  static class Ifeq extends OpCodes {
 ...
 byte branchbyte2;
  ...
  static class Ifne extends OpCodes {
 ...
 byte branchbyte2;
  ...
  static class Iflt extends OpCodes {
 ...
 byte branchbyte2;
  ...
  static class Ifge extends OpCodes {
 ...
 byte branchbyte2;
  ...
  static class Ifgt extends OpCodes {
 ...
 byte branchbyte2;
  ...
  static class Ifle extends OpCodes {
 ...
 byte branchbyte2;
  ...
  static class Ifnonnull extends OpCodes {

    Ifnonnull(){ super(199, "ifnonnull"); }
 byte branchbyte1;
 byte branchbyte2;
  ...
  static class Ifnull extends OpCodes {

    Ifnull(){ super(198, "ifnull"); }
 byte branchbyte1;
 byte branchbyte2;
  ...
  static class Iinc extends OpCodes {
 ...
 byte constbyte;
  ...
  static class Iload extends OpCodes {

    Iload(){ super(21, "iload"); }
 byte index;
  ...
  static class Iload_0 extends OpCodes {

    Iload_0(){ super(26, "iload_0"); }
  ...
  static class Iload_1 extends OpCodes {

    Iload_1(){ super(27, "iload_1"); }
  ...
  static class Iload_2 extends OpCodes {

    Iload_2(){ super(28, "iload_2"); }
  ...
  static class Iload_3 extends OpCodes {

    Iload_3(){ super(29, "iload_3"); }
  ...
  static class Imul extends OpCodes {
  ...
  static class Ineg extends OpCodes {
  ...
  static class Instanceof extends OpCodes {

    Instanceof(){ super(193, "instanceof"); }
 byte indexbyte1;
 byte indexbyte2;
  ...
  static class Invokedynamic extends OpCodes {

    Invokedynamic(){ super(186, "invokedynamic"); }
 byte indexbyte1;
 byte indexbyte2;
 byte indexbyte3;
 byte indexbyte4;
  ...
  static class Invokeinterface extends OpCodes {

    Invokeinterface(){ super(185, "invokeinterface"); }
 byte indexbyte1;
 byte indexbyte2;
 byte count;
 byte zero;
  ...
  static class Invokespecial extends OpCodes {

    Invokespecial(){ super(183, "invokespecial"); }
 byte indexbyte1;
 byte indexbyte2;
  ...
  static class Invokestatic extends OpCodes {

    Invokestatic(){ super(184, "invokestatic"); }
 byte indexbyte1;
 byte indexbyte2;
  ...
  static class Invokevirtual extends OpCodes {

    Invokevirtual(){ super(182, "invokevirtual"); }
 byte indexbyte1;
 byte indexbyte2;
  ...
  static class Ior extends OpCodes {
  ...
  static class Irem extends OpCodes {
  ...
  static class Ireturn extends OpCodes {

    Ireturn(){ super(172, "ireturn"); }
  ...
  static class Ishl extends OpCodes {
  ...
  static class Ishr extends OpCodes {
  ...
  static class Istore extends OpCodes {

    Istore(){ super(54, "istore"); }
 byte index;
  ...
  static class Istore_0 extends OpCodes {

    Istore_0(){ super(59, "istore_0"); }
  ...
  static class Istore_1 extends OpCodes {

    Istore_1(){ super(60, "istore_1"); }
  ...
  static class Istore_2 extends OpCodes {

    Istore_2(){ super(61, "istore_2"); }
  ...
  static class Istore_3 extends OpCodes {

    Istore_3(){ super(62, "istore_3"); }
  ...
  static class Isub extends OpCodes {
  ...
  static class Iushr extends OpCodes {

    Iushr(){ super(124, "iushr"); }
  ...
  static class Ixor extends OpCodes {
  ...
  static class Jsr extends OpCodes {
 ...
 byte indexbyte2;
  ...
  static class Jsr_w extends OpCodes {

    Jsr_w(){ super(201, "jsr_w"); }
 byte branchbyte1;
 byte branchbyte2;
 byte branchbyte3;
 byte branchbyte4;
  ...
  static class L2d extends OpCodes {
  ...
  static class L2f extends OpCodes {
  ...
  static class L2i extends OpCodes {
  ...
  static class Ladd extends OpCodes {
  ...
  static class Laload extends OpCodes {

    Laload(){ super(47, "laload"); }
  ...
  static class Land extends OpCodes {
  ...
  static class Lastore extends OpCodes {

    Lastore(){ super(80, "lastore"); }
  ...
  static class Lcmp extends OpCodes {
  ...
  static class Lconst_0 extends OpCodes {

    Lconst_0(){ super(9, "lconst_0"); }
  ...
  static class Lconst_1 extends OpCodes {

    Lconst_1(){ super(10, "lconst_1"); }
  ...
  static class Ldc extends OpCodes {
 ...
 byte index;
  ...
  static class Ldc_w extends OpCodes {

    Ldc_w(){ super(19, "ldc_w"); }
 byte indexbyte1;
 byte indexbyte2;
  ...
  static class Ldc2_w extends OpCodes {

    Ldc2_w(){ super(20, "ldc2_w"); }
 byte indexbyte1;
 byte indexbyte2;
  ...
  static class Ldiv extends OpCodes {
  ...
  static class Lload extends OpCodes {

    Lload(){ super(22, "lload"); }
 byte index;
  ...
  static class Lload_0 extends OpCodes {

    Lload_0(){ super(30, "lload_0"); }
  ...
  static class Lload_1 extends OpCodes {

    Lload_1(){ super(31, "lload_1"); }
  ...
  static class Lload_2 extends OpCodes {

    Lload_2(){ super(32, "lload_2"); }
  ...
  static class Lload_3 extends OpCodes {

    Lload_3(){ super(33, "lload_3"); }
  ...
  static class Lmul extends OpCodes {
  ...
  static class Lneg extends OpCodes {
  ...
  static class Lookupswitch extends OpCodes {

    Lookupswitch(){ super(171, "lookupswitch"); }
 int defaultbyte1;
 int defaultbyte2;
 int defaultbyte3;
 int defaultbyte4;
 ...
 int[] matchOffsetsPairs;
  ...
  static class Lor extends OpCodes {
  ...
  static class Lrem extends OpCodes {
  ...
  static class Lreturn extends OpCodes {

    Lreturn(){ super(173, "lreturn"); }
  ...
  static class Lshl extends OpCodes {
  ...
  static class Lshr extends OpCodes {
  ...
  static class Lstore extends OpCodes {

    Lstore(){ super(55, "lstore"); }
 byte index;
  ...
  static class Lstore_0 extends OpCodes {

    Lstore_0(){ super(63, "lstore_0"); }
  ...
  static class Lstore_1 extends OpCodes {

    Lstore_1(){ super(64, "lstore_1"); }
  ...
  static class Lstore_2 extends OpCodes {

    Lstore_2(){ super(65, "lstore_2"); }
  ...
  static class Lstore_3 extends OpCodes {

    Lstore_3(){ super(66, "lstore_3"); }
  ...
  static class Lsub extends OpCodes {
  ...
  static class Lushr extends OpCodes {

    Lushr(){ super(125, "lushr"); }
  ...
  static class Lxor extends OpCodes {
  ...
  static class Monitorenter extends OpCodes {

    Monitorenter(){ super(194, "monitorenter"); }
  ...
  static class Monitorexit extends OpCodes {

    Monitorexit(){ super(195, "monitorexit"); }
  ...
  static class Multianewarray extends OpCodes {

    Multianewarray(){ super(197, "multianewarray"); }
 byte indexbyte1;
 byte indexbyte2;
 byte dims;
  ...
  static class New extends OpCodes {
 ...
 byte indexbyte2;
  ...
  static class Newarray extends OpCodes {

    Newarray(){ super(188, "newarray"); }
 byte atype;
  ...
  static class Nop extends OpCodes {
  ...
  static class Pop extends OpCodes {
  ...
  static class Pop2 extends OpCodes {
  ...
  static class Putfield extends OpCodes {

    Putfield(){ super(181, "putfield"); }
 byte indexbyte1;
 byte indexbyte2;
  ...
  static class Putstatic extends OpCodes {

    Putstatic(){ super(179, "putstatic"); }
 byte indexbyte1;
 byte indexbyte2;
  ...
  static class Ret extends OpCodes {
 ...
 byte index;
  ...
  static class Return extends OpCodes {

    Return(){ super(177, "return"); }
  ...
  static class Saload extends OpCodes {

    Saload(){ super(53, "saload"); }
  ...
  static class Sastore extends OpCodes {

    Sastore(){ super(86, "sastore"); }
  ...
  static class Sipush extends OpCodes {

    Sipush(){ super(17, "sipush"); }
 byte sbyte1;
 byte sbyte2;
  ...
  static class Swap extends OpCodes {
  ...
  static class Tableswitch extends OpCodes {

    Tableswitch(){ super(170, "tableswitch"); }
 int defaultbyte1;
 int defaultbyte2;
 int defaultbyte3;
 int defaultbyte4;
 ...
 int[] offsets;
  ...
  static class Wide extends OpCodes {
